...
test(`resolves serverSlot without treating other mixed-case text as a variable`, () => {
  assert.equal(resolveTemplate(`[serverSlot] [otherTag]`, { serverSlot: `40` }), `40 [otherTag]`)
})
