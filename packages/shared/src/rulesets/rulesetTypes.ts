...
export type RuleCondition =
  | { mode: `if`, definition: RuleDefinitionKey, operator: RuleOperator, value: string | number, triggerOnce?: boolean }
...
export type RulePreview = { targets: ActionTarget[], falseTargets?: ActionTarget[], unavailable: { playfabId?: string, reason: string }[] }
