...
public sealed class ConsoleCommandServiceTests
{
    ...
    public async Task TypedListPlayersRejectsMissingInteractiveTargetBeforeInput()
    {
        ...
        Assert.Null(fixture.CommandActivity.GetSnapshot());
    }
    ...
    public async Task TypedBackgroundListPlayersPreservesClipboardParsingWarningsAndLastSummary()
    {
        ...
        Assert.Equal("ListPlayers", fixture.CommandActivity.GetSnapshot()!.Command);
        ...
        IGameInputActivityGate? activityGate = null)
    {
        ...
        var commandActivity = new ConsoleCommandActivity();
        ...
        return new Fixture(service, targets, clipboard, keyboard, windowApi, gate, commandActivity);
    }
    ...
    private sealed record Fixture(
        ...
        ConsoleCommandGate Gate,
        ConsoleCommandActivity CommandActivity);
