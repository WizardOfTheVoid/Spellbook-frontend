...
public sealed class GameActionRuntimeTests
{
    ...
    private sealed class NativeApi : IWindowApi, IWindowReadiness, IKeyboardInputApi
    {
        ...
        public bool SetForegroundWindow(IntPtr handle) { FocusRequests.Add(handle); Foreground = handle; return true; }
