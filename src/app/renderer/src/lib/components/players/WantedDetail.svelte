...
<section class="panel-view panel-view--sub wanted-detail" aria-label="Wanted player detail">
	...
	>
		<svelte:fragment slot="title">
			<PlayerPresenceName name={playerName} isOnline={detail?.presence?.isOnline ?? detail?.player.isOnline ?? player.isOnline} presence={detail?.presence} />
		</svelte:fragment>
	...
	<div class="wanted-detail__body" aria-busy={viewState.loading} use:navigationScroll={`wantedDetail`}>
