...
export function createPlayerInfinityMenu(
	...
	const issue = gameCommandIssue(dependencies.gameAvailable === true, dependencies.commandsBlocked, dependencies.commandIssue)
	...
	items.push(
		...
		},
		{
			...
			loadChildren: () => dependencies.loadProfileActions
				...
				: loadProfileActionMenu(target, { excludeUnban: Boolean(dependencies.wanted), groupByType: true }),
		},
	)
