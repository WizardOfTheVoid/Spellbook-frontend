...
<p class="note-help">Type <strong>@</strong> to mention an admin or <strong>#</strong> to link an action from this player's history. Choose a suggestion to insert it.</p>

<style lang="scss">
  .note-help { margin: 0; color: var(--color-light-tertiary); font-size: var(--font-size-xs); line-height: 1.5; }
  .player-note-editor {
    min-height: 7rem;
