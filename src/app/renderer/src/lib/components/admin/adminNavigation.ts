...
export type AdminView = 'tag-types' | 'root' | 'user' | 'team' | 'discord-queue' | AdminRootView
...
const rootTiles: AdminRootTile[] = [
  ...
  { view: `ux-ui`, title: `UX & UI`, subtitle: `Replay first login and update experiences`, icon: `fa-wand-magic-sparkles` },
