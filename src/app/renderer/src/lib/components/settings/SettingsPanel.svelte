...
<section {hidden} class="panel-view settings-view" aria-label="Settings">
	...
	<div class="settings-list" use:navigationScroll={`settings-list`}>
		<KeybindSetting name="consoleKey" {hidden} disabled={saving} />
		...
		<div class="settings-row">
			...
			<span class="settings-row__copy"><strong>Debug</strong><small>Show game activity and chat cooldown.</small></span>
