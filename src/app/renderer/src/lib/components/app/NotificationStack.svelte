<script lang="ts">
	...
	import NotificationIcon from "$lib/components/notifications/notificationIcon.svelte"
	import {
	...
	>
		{#each notifications as notification (notification.id)}
			...
			>
				...
				>
					<span class="notification-item__icon" aria-hidden={notification.avatarUrl ? undefined : true}>
						<NotificationIcon
