<script lang="ts">
	import MessagePreview from "$lib/components/messages/messagePreview.svelte"
...
<div class="quick-action-modal" bind:this={modalRoot}>
	...
	>
		...
		<form on:submit|preventDefault={onSend}>
			...
			<MessagePreview {kind} message={resolvedMessage} />
			...
			<footer>
				...
				<button
					...
					type="submit"
					disabled={sending || !draft.trim() || resolvedMessage.length > 180}
				>
