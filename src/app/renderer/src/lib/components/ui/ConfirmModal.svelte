...
<div class="confirm-modal" bind:this={modalRoot}>
	...
	>
		...
		<footer>
			...
			{#if showConfirm}<button class="confirm-modal__confirm" class:confirm-modal__confirm--primary={confirmTone === `primary`} type="button" disabled={busy || confirmDisabled} on:click={onConfirm}>
...
<style lang="scss">
	...
	.confirm-modal__content :global(.ui-multi-select__popover) { position: static; }
