...
export const overlayPlacementPreference = [`right`, `bottom`, `top`, `left`] as const
...
export function placeAnchoredOverlay(
	...
	placement: OverlayPlacement = overlayPlacementPreference[0],
	gap = overlayGap,
	margin = 12,
): OverlayPosition {
	const placements = [placement, ...overlayPlacementPreference.filter(side => side !== placement)]
