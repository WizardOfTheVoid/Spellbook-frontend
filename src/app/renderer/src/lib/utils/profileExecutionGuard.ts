...
import { isGameRunning } from '$lib/gameState/gameStateStore'
...
function checkContext(
  ...
  const issue = gameCommandIssue(!requiresGame || isGameRunning(), get(consoleSetup).commandsBlocked, get(consoleSetup).commandIssue)
