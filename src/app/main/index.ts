...
import { antiAfkConfig, coreAuthToken, coreBaseUrl, debugHistoryLimit, debugRunLimit, debugStatusIntervalMs, focusMonitorMs, notificationPollMs, resolveServerBaseUrl, serverAuthToken, wantedRuntimeConfig, pulseConfig } from './config'
...
const runtime = new MainRuntimeCoordinator([consoleSetup, listPlayersPoller, wantedWorker], currentGameSnapshots)
const debugTools = createDebugTools({
  getAppMetrics: () => app.getAppMetrics(),
	...
	producers: { listPlayers: listPlayersPoller, wanted: wantedWorker, antiAfk: antiAfkService },
