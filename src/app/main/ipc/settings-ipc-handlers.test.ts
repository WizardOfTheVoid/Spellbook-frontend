...
test(`console binds stay local when server preferences are read or saved`, async () => {
  ...
  const settings = { audioSfxEnabled: true, audioSfxVolume: 0.5, selectedDisplayId: 7, consoleKey: `Backquote`, overlayKey: `F6`, quickOpenPlayerKey: `F7` }
  ...
  new SettingsIpcHandlers(
    ...
    {
      getServer: async () => ({ ok: true, data: { data: { audioSfxEnabled: false, consoleKey: `F6`, overlayKey: `F3`, quickOpenPlayerKey: `F4` } } }),
