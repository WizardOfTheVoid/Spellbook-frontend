...
test(`protocol discovery returns a valid player URL`, () => {
  assert.equal(findAppProtocolUrl([`--flag`, `spellbook://players/ABC_123`]), `spellbook://players/ABC_123`)
  assert.equal(findAppProtocolUrl([`spellbook://players/%2Fetc`]), undefined)
})
